    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    {!! Form::open(['route'=>'futsal.store','method'=>'POST','novalidate','data-parsley-validate' ,'id'=>'demo-form2','class'=>'form-horizontal form-label-left','files' => true]) !!}
                    <div class="row">
                        <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('admin', null,['class'=>$errors->first('admin')?'parsley-error form-control':''.'form-control','required'=>'required','id'=>'admin','Placeholder'=>'Admin Name']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('email', null,['class'=>$errors->first('email')?'parsley-error form-control':''.'form-control','required'=>'required','id'=>'email','Placeholder'=>'Admin Email']) !!}
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('payment_gateway[]', $payment_gateways, null,['class'=>$errors->first('payment_gateway')?'parsley-error form-control':''.'form-control','id'=>'payment_gateway','Placeholder'=>'Payment gateway','multiple']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" value="1" class="flat" name="book_via_app" checked>
