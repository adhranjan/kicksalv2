                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-newspaper-o"></i> General <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ route(explode('_',Auth::User()->roles()->first()->name)[0].'_home') }}">Home</a></li>
                        </ul>
                    </li>
                    ...
                    @permission('manage-my-futsal')
                        <li><a><i class="fa fa-newspaper-o"></i> Futsal Setting <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
